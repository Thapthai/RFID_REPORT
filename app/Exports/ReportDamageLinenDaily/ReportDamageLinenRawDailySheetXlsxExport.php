...
class ReportDamageLinenRawDailySheetXlsxExport implements FromView, WithDrawings, WithEvents, WithTitle
{
    ...
    public function view(): View
    {
        ...
        $data = DB::select("
            ...
            WHERE DATE(damagenh.DocDate) = ?
            ORDER BY department.DepName, item.ItemName ASC
        ", [$DocDate]);

        // dd($data);
 
        return view('exports.reportDamageDaily_xlsx.reportDamageLinenRawDaily', compact(
            'data',
            'currentMonthName',
            'previousMonthName',
            'currentYear',
